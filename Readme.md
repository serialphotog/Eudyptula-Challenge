This repository contains my solutions to the *Eudyptula Challenges*. At the moment I am actively working on these challenges, so this is not the place if you're looking for completed solutions.

At the time of this writing, the challenges are no longer officially available, so I am doing them based on their posting on [this repository](https://github.com/agelastic/eudyptula).

## The Challenges

Here are the list of challenges, repeated from the linked repository.
